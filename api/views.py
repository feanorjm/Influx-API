...
from api.serializers import UserSerializer, GroupSerializer, ValidateMailFormSerializer
...
class EmailNotification(APIView):
    def post(self,request,format=None):
        ...
        valid_ser = ValidateMailFormSerializer(data=request.data)
        if valid_ser.is_valid():
            ...
            if (estado == 'Enabled'):
                ...
                return Response({'message': 'El hub no está habilitado o no existe'})
